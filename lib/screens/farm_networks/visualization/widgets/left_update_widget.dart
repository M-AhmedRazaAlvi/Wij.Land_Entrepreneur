...
class LeftUpdateWidget extends StatefulWidget {
  const LeftUpdateWidget({Key? key}) : super(key: key);

  @override
  State<LeftUpdateWidget> createState() => _LeftUpdateWidgetState();
}

class _LeftUpdateWidgetState extends State<LeftUpdateWidget> {
  int solidCount = 0,
      nCount = 0,
      nh3Count = 0,
      ditchCount = 0,
