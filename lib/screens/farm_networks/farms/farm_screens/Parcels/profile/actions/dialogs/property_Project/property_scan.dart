...
class PropertyScanHerbs extends StatefulWidget {
  const PropertyScanHerbs({Key? key}) : super(key: key);

  @override
  State<PropertyScanHerbs> createState() => _PropertyScanHerbsState();
}

class _PropertyScanHerbsState extends State<PropertyScanHerbs> {
