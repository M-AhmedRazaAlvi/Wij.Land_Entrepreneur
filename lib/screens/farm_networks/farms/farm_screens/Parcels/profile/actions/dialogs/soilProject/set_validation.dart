...
class SetVelidationPlot extends StatefulWidget {
  const SetVelidationPlot({Key? key}) : super(key: key);

  @override
  State<SetVelidationPlot> createState() => _SetVelidationPlotState();
}

class _SetVelidationPlotState extends State<SetVelidationPlot> {
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: CustomText(
              text: "Soil Project / Set Validation Plot",
              size: 25,
