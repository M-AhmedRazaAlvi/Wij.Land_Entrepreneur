...
class SoilSampleScreen extends StatefulWidget {
  const SoilSampleScreen({Key? key}) : super(key: key);

  @override
  State<SoilSampleScreen> createState() => _SoilSampleScreenState();
}

class _SoilSampleScreenState extends State<SoilSampleScreen> {
