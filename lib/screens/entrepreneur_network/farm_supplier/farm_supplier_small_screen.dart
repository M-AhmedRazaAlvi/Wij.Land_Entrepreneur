...
class FarmSupplierSmallScreen extends StatefulWidget {
  GetFarmSupplierResponse? response;

  FarmSupplierSmallScreen({Key? key, this.response}) : super(key: key);

  @override
  State<FarmSupplierSmallScreen> createState() => _FarmSupplierSmallScreenState();
}

class _FarmSupplierSmallScreenState extends State<FarmSupplierSmallScreen> {
          ...
          showLoading.value == true
              ...
              : widget.response!.data == null || widget.response!.data!.isEmpty
                  ...
                  : _provider.isMapDisplay
                      ...
                      : Expanded(
                          child: FarmSupplierDataTableCard(
