...
import 'package:wij_land/screens/sustainable_finance/entrepreneurs/overview/widgets/search_project_widget.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SelectableDropdownWidget(
                        ...
                        mSelectedItemsList:
                            _provider.mSelectedEntrepreneurProductsList,
                        mOnDropDownChange: (value) {
                          setState(
                            () {
                              _provider.mSelectedProductsType = value as String;
                              if (!_provider.mSelectedEntrepreneurProductsList
