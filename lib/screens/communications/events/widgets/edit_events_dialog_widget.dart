...
class EditEventsDialogWidget extends StatefulWidget {
  const EditEventsDialogWidget({Key? key}) : super(key: key);

  @override
  State<EditEventsDialogWidget> createState() => _EditEventsDialogWidgetState();
}

class _EditEventsDialogWidgetState extends State<EditEventsDialogWidget> {
