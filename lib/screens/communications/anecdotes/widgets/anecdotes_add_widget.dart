...
class AddAnecdotesWidget extends StatefulWidget {
  const AddAnecdotesWidget({Key? key}) : super(key: key);

  @override
  State<AddAnecdotesWidget> createState() => _AddAnecdotesWidgetState();
}

class _AddAnecdotesWidgetState extends State<AddAnecdotesWidget> {
