...
class SelectableDropdownWidget extends StatefulWidget {
  ...
  @override
  State<SelectableDropdownWidget> createState() => _SelectableDropdownWidgetState();
}
                    ...
                    children: [
                      DropdownButtonHideUnderline(
                        child: DropdownButton(
                          ...
                          items: this.widget.items.map((String items) {
                          ...
                          selectedItemBuilder: (BuildContext context) {
                            return this.widget.items.map((String items) {
                              return DropdownMenuItem(
                                  value: items,
                                  child: Text(
                                    items,
