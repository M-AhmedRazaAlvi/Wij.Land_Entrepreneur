...
PostEntrepreneurSupplierResponse postEntrepreneurSupplierResponseFromJson(
        String str) =>
    PostEntrepreneurSupplierResponse.fromJson(json.decode(str));

String postEntrepreneurSupplierResponseToJson(
        PostEntrepreneurSupplierResponse request) =>
    json.encode(request.toJson());

class PostEntrepreneurSupplierResponse {
  Data? data;
  String? message;
  int? status;

  PostEntrepreneurSupplierResponse({this.data, this.message, this.status});

  PostEntrepreneurSupplierResponse.fromJson(Map<String, dynamic> json) {
