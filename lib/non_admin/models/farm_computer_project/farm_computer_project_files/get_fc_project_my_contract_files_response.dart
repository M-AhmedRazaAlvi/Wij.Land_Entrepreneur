class GetFCProjectMyContractFilesResponse {
  List<Data>? data;
  String? message;
  int? status;
  Error? error;
  GetFCProjectMyContractFilesResponse({this.data, this.message, this.status, this.error});

  GetFCProjectMyContractFilesResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
