class GetFCProjectMyBookmarkFilesResponse {
  List<Data>? data;
  String? message;
  int? status;

  GetFCProjectMyBookmarkFilesResponse({this.data, this.message, this.status});

  GetFCProjectMyBookmarkFilesResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
