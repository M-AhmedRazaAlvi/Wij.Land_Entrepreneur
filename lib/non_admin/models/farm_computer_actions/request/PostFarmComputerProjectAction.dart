class PostFarmComputerProjectAction {
  Data? data;
  String? message;
  int? status;

  PostFarmComputerProjectAction({this.data, this.message, this.status});

  PostFarmComputerProjectAction.fromJson(Map<String, dynamic> json) {
