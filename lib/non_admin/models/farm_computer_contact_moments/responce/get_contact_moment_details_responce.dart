class GetFarmComputerContactMomentDetailsResponce {
  Data? data;
  String? message;
  int? status;

  GetFarmComputerContactMomentDetailsResponce(
      {this.data, this.message, this.status});

  GetFarmComputerContactMomentDetailsResponce.fromJson(
      Map<String, dynamic> json) {
    print("object of parcels ${json['data']}");
